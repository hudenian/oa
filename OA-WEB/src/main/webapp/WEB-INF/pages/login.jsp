            ...
            <div id="LoginInfo">
                <table BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input name="loginName" size="20" tabindex="1" cssClass="TextField required" id="loginNameInput" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input name="password" id="aa" size="20" tabindex="2" showPassword="false" cssClass="TextField required" /></td>
                    </tr>
                </table>
            </div>
            <div id="CopyRight"><a href="javascript:void(0)">&copy; 2016 版权所有 </a></div>
        </div>
    </div>
    </form:form>
</body>
