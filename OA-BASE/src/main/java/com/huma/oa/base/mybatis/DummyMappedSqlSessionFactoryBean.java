package com.huma.oa.base.mybatis;
...
import com.huma.oa.base.utils.PackageUtil;
import com.huma.oa.base.utils.StringUtils;
...
public class DummyMappedSqlSessionFactoryBean extends SqlSessionFactoryBean {
    ...
    public void setTypeAliasesPackage(String typeAliasesPackage) {
        ...
        if (packages.size() == 0) {
            ...
            if (StringUtils.isEmpty(packageStr)) packageStr = defaultTypeAliasesPackage;
        }
        // --------------------------------------------------------------------------------------------------------------------------------------
